  ...
  return function (o, s) {
    var a,
      ...
      K = function () {
        if (
          ((I = !I)
            ? (s.removeClass(m, 'pswp__share-modal--fade-in'),
              setTimeout(function () {
                I && k()
              }, 300))
            : (k(),
      ...
      A = function (e) {
        ...
        !o.likelyTouchDevice || g.mouseUsed || screen.width > g.fitControlsWidth
          ? ((t = g.barsSize),
            g.captionEl && 'auto' === t.bottom
              ? (p ||
                  ((p = s.createEl(
                    'pswp__caption pswp__caption--fake'
                  )).appendChild(s.createEl('pswp__caption__center')),
                  u.insertBefore(p, c),
                  s.addClass(u, 'pswp__ui--fit')),
                g.addCaptionHTMLFn(e, p, !0)
    ...
    ;(C.init = function () {
      ...
      s.extend(o.options, E, !0),
        (g = o.options),
        (u = s.getChildByClass(o.scrollWrap, 'pswp__ui')),
        (f = o.listen)('onVerticalDrag', function (e) {
          T && e < 0.95 ? C.hideControls() : !T && 0.95 <= e && C.showControls()
        }),
        f('onPinchClose', function (e) {
          T && e < 0.9
            ? (C.hideControls(), (t = !0))
            : t && !T && 0.9 < e && C.showControls()
        }),
        f('zoomGestureEnded', function () {
          ;(t = !1) && !T && C.showControls()
        }),
        f('beforeChange', C.update),
        f('doubleTap', function (e) {
          var t = o.currItem.initialZoomLevel
          o.getZoomLevel() !== t
            ? o.zoomTo(t, e, 333)
            : o.zoomTo(g.getDoubleTapZoom(!1, o.currItem), e, 333)
        }),
        ...
        f('bindEvents', function () {
          s.bind(u, 'pswpTap click', F),
            s.bind(o.scrollWrap, 'pswpTap', C.onGlobalTap),
            o.likelyTouchDevice ||
              s.bind(o.scrollWrap, 'mouseover', C.onMouseOver)
        }),
        f('unbindEvents', function () {
          I || K(),
            _ && clearInterval(_),
            s.unbind(document, 'mouseout', y),
            s.unbind(document, 'mousemove', R),
            s.unbind(u, 'pswpTap click', F),
            s.unbind(o.scrollWrap, 'pswpTap', C.onGlobalTap),
            s.unbind(o.scrollWrap, 'mouseover', C.onMouseOver),
            a &&
              (s.unbind(document, a.eventK, C.updateFullscreen),
              a.isFullscreen() && ((g.hideAnimationDuration = 0), a.exit()),
              (a = null))
        }),
        f('destroy', function () {
          g.captionEl &&
            (p && u.removeChild(p), s.removeClass(c, 'pswp__caption--empty')),
            m && (m.children[0].onclick = null),
            s.removeClass(u, 'pswp__ui--over-close'),
        ...
        (n = s.getChildByClass(u, 'pswp__top-bar')) && e(n.children),
        g.shareEl && d && m && (I = !0),
        S(),
        g.timeToIdle &&
          f('mouseUsed', function () {
            s.bind(document, 'mousemove', R),
              s.bind(document, 'mouseout', y),
        ...
        g.fullscreenEl &&
          ...
          ((a = a || C.getFullscreenAPI())
            ? (s.bind(document, a.eventK, C.updateFullscreen),
              C.updateFullscreen(),
      ...
      (C.update = function () {
        ;(e =
          ...
          g.captionEl &&
            (g.addCaptionHTMLFn(o.currItem, c),
            x(c, 'caption--empty', !o.currItem.title)),
          !0)),
          I || K(),
          S()
      }),
      (C.updateFullscreen = function (e) {
        e &&
          ...
          s[(a.isFullscreen() ? 'add' : 'remove') + 'Class'](
            o.template,
            'pswp--fs'
          )
      }),
      (C.updateIndexIndicator = function () {
        g.counterEl &&
          (t.innerHTML =
            o.getCurrentIndex() + 1 + g.indexIndicatorSep + g.getNumItemsFn())
      }),
            ...
            ? L(t)
              ...
              : s.hasClass(t, 'pswp__img') &&
                ...
                o.getZoomLevel() <= o.currItem.fitRatio
                  ? g.clickToCloseNonZoomable && o.close()
                  : o.toggleDesktopZoom(e.detail.releasePoint))
            : (g.tapToToggleControls &&
                (T ? C.hideControls() : C.showControls()),
              g.tapToClose &&
                (s.hasClass(t, 'pswp__img') || L(t)) &&
                o.close()))
      }),
