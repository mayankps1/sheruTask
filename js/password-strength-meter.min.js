  ...
  var d = {
    ...
    strengthMeter: function () {
      ...
      d.includeMeter(s, e),
        ...
        -1 !== s &&
        o
          ? r.attr('disabled', 'disabled').addClass('disabled')
    ...
    includeMeter: function (s, r) {
      ...
      '' === r.val()
        ...
        ? (r.after(
          ...
          a(document.body).trigger('wc-password-strength-added'))
    ...
    checkPasswordStrength: function (s, r) {
      var e = s.find('.woocommerce-password-strength'),
        ...
        t =
          ...
          '</small>',
        r = wp.passwordStrength.meter(
          r.val(),
          wp.passwordStrength.userInputDisallowedList()
        ),
        o = ''
      if (
        (e.removeClass('short bad good strong'), s.remove(), !e.is(':hidden'))
      )
        switch (
          (r < wc_password_strength_meter_params.min_password_strength &&
            (o = ' - ' + wc_password_strength_meter_params.i18n_password_error),
          r)
        ) {
          case 0:
