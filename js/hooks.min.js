...
!(function () {
  ...
  var s = function (n, t) {
    ...
    return function (e) {
      ...
      const i = o[e].handlers
      for (
        var c = arguments.length, s = new Array(c > 1 ? c - 1 : 0), u = 1;
        u < c;
        u++
      )
        s[u - 1] = arguments[u]
      if (!i || !i.length) return r ? s[0] : void 0
      const l = { name: e, currentIndex: 0 }
      for (o.__current.push(l); l.currentIndex < i.length; ) {
        const n = i[l.currentIndex].callback.apply(null, s)
        r && (s[0] = n), l.currentIndex++
      }
