  ...
  var r = function (t) {
    ...
    o = function (t, e) {
      var o,
        ...
        a =
          ...
          c)
      if (0 === n('.woocommerce-cart-form').length) window.location.reload()
      else {
        if (
          (e ||
            n(
          ...
          e = n('.cart-empty', t).closest('.woocommerce')
          ...
          n('.woocommerce-checkout').length &&
            ...
            n('.woocommerce-cart-form').replaceWith(i),
    ...
    t = {
      ...
      cart_submit: function (t) {
        ...
        if (
          0 !==
          (c = c.is('form') ? c : n(t.currentTarget).parents('form')).find(
      ...
      remove_coupon_clicked: function (t) {
        ...
        var e = this,
          ...
          t =
            (a(o), { security: wc_cart_params.remove_coupon_nonce, coupon: c })
        n.ajax({
          type: 'POST',
          url: r('remove_coupon'),
          data: t,
