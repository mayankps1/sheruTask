jQuery(function (u) {
  ...
  var t,
    e = wc_country_select_params.countries.replace(/&quot;/g, '"'),
    d = JSON.parse(e),
    h =
  ...
  u(document.body).on(
    ...
    function () {
      var t,
        ...
        o = u(this).closest(h),
        c =
          (o.length || (o = u(this).closest('.form-row').parent()),
          u(this).val()),
        a = o.find('#billing_state, #shipping_state, #calc_shipping_state'),
      ...
      d[c]
        ? (u.isEmptyObject(d[c])
            ...
            : ((e = d[c]),
              ...
              a.empty().append(n),
              u.each(e, function (t) {
                t = u('<option></option>').prop('value', t).text(e[t])
                a.append(t)
              }),
              a.val(l).trigger('change')),
          u(document.body).trigger('country_to_state_changed', [c, o]))
        : a.is('select, input[type="hidden"]') &&
          ...
          a.replaceWith(t),
          u(document.body).trigger('country_to_state_changed', [c, o])),
        u(document.body).trigger('country_to_state_changing', [c, o])
    }
  ),
