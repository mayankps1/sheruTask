        ...
        p(n).on('click', '.wpforms-page-button', function (e) {
          ...
          p(n).on(
            ...
            function (e) {
              ...
              13 === e.which && p('#' + t.attr('for')).trigger('click')
            }
          ),
      ...
      navigateToPage: function (e, t, r, a, o) {
        ...
        'next' === t ? (i += 1) : 'prev' === t && --i,
          WPFormsUtils.triggerEvent(e, 'wpformsBeforePageChange', [
            ...
            (t = l.getPageScroll(a)) &&
              l.animateScrollTop(a.offset().top - t, 750, null),
            e.trigger('wpformsPageChange', [i, a]),
      ...
      formHasCaptcha: function (e) {
        return (
          !(
            !e ||
            !e.length ||
            ('undefined' == typeof hcaptcha && 'undefined' == typeof grecaptcha)
      ...
      setCurrentPage: function (a, o) {
        if (0 !== a.find('.wpforms-page-indicator').length) {
          ...
          a.find('.wpforms-page').each(function (e, t) {
            if (1 <= p(t).find('.wpforms-has-error').length) return r.push(p(t))
          })
