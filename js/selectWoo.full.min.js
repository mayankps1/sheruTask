...
!(function (n) {
  ...
  ;((u =
    ...
    ((a = function (e, t, n) {
      ...
      t.splice || ((n = t), (t = [])), _(g, e) || _(m, e) || (m[e] = [e, t, n])
    }).amd = { jQuery: !0 }),
    (u.requirejs = o),
    (u.require = e),
    (u.define = a)),
        ...
        (e.Decorate = function (i, o) {
          ...
          for (var a = 0; a < e.length; a++) {
            ...
            s.prototype[l] = (function (e) {
              var t = function () {},
                n = (e in s.prototype && (t = s.prototype[e]), o.prototype[e])
              return function () {
                return (
          ...
          if (e.children) {
            for (
              var s = d(n),
                ...
                a = ((r.className = 'select2-results__group'), d(r)),
                l = (this.template(e, r), a.attr('role', 'presentation'), []),
                c = 0;
              c < e.children.length;
              c++
            ) {
            ...
            i(document.body).on('mousedown.select2.' + e.id, function (e) {
              ...
              i('.select2.select2-container--open').each(function () {
                ...
                this != n[0] &&
                  ...
                  setTimeout(function () {
                    e.find('*:focus').trigger('blur'), t.trigger('focus')
                  }, 1))
              })
            })
          }),
      ...
      function (e, t, i, n) {
        ...
        return (
          ...
          (s.prototype.bind = function (t, e) {
            var n = this,
              i =
                (s.__super__.bind.apply(this, arguments), t.id + '-container'),
              o =
                (this.$selection
            ...
            'string' == typeof o
              ? this.$selection.attr('aria-label', o)
          ...
          (s.prototype.update = function (e) {
            ...
            0 === e.length
              ...
              : ((e = e[0]),
                ...
                (n = i.entityDecode(this.display(e, t))),
                t.empty().text(n),
                t.prop('title', e.title || e.text))
          }),
          s
        )
      }
    ...
    u.define('select2/translation', ['jquery', 'require'], function (t, n) {
      ...
      return (
        ...
        (i.loadPath = function (e) {
          var t
          return (
            e in i._cache || ((t = n(e)), (i._cache[e] = t)), new i(i._cache[e])
          )
        }),
        i
      )
    ...
    u.define('select2/data/base', ['../utils'], function (i) {
      ...
      return (
        ...
        (n.prototype.generateResultId = function (e, t) {
          var n =
            (n =
              (n = '') + (null != e ? e.id : i.generateChars(4)) + '-result-') +
            i.generateChars(4)
          return (
            null != t.id
              ? (n += '-' + t.id.toString())
        ...
        return (
          ...
          (n.prototype.select = function (o) {
            ...
            ;(o.selected = !0),
              r(o.element).is('option')
                ? ((o.element.selected = !0), this.$element.trigger('change'))
          ...
          (n.prototype.unselect = function (o) {
            ...
            this.$element.prop('multiple') &&
              ((o.selected = !1),
              r(o.element).is('option')
                ? ((o.element.selected = !1), this.$element.trigger('change'))
                : this.current(function (e) {
                    for (var t = [], n = 0; n < e.length; n++) {
                      var i = e[n].id
          ...
          (n.prototype.option = function (e) {
            e.children
              ...
              : (t = document.createElement('option')).textContent !== undefined
    ...
    u.define('select2/data/tags', ['jquery'], function (t) {
      function e (e, t, n) {
        var i = n.get('tags'),
          o = n.get('createTag'),
          o = (o !== undefined && (this.createTag = o), n.get('insertTag'))
        if (
      ...
      return (
        ...
        (e.prototype.createTag = function (e, t) {
          t = t.term || 0 == t.term ? t.term.toString().trim() : ''
          ...
          e.call(this, t, n),
            ...
            this.$results.on('scroll', function () {
              ...
              !i.loading &&
                ...
                i.$loadingMore.offset().top + i.$loadingMore.outerHeight(!1) <=
                  e + 50 && i.loadMore())
            })
        }),
    ...
    u.define(
      ...
      function (c, r) {
        function e (e, t, n) {
          ;(this.$dropdownParent = n.get('dropdownParent') || c(document.body)),
            e.call(this, t, n)
        }
        return (
          (e.prototype.bind = function (e, t, n) {
          ...
          (e.prototype._positionDropdown = function () {
            ...
            var r = this.$dropdown.outerHeight(!1),
              ...
              l = (l =
                'static' === l.css('position') ? l.offsetParent() : l).offset()
            ;(o.left -= l.left),
              t || n || (i = 'below'),
    ...
    u.define('select2/dropdown/selectOnClose', [], function () {
      ...
      return (
        ...
        (e.prototype._handleSelectOnClose = function (e, t) {
          ...
          t.length < 1 ||
            (null != (t = t.data('data')).element && t.element.selected) ||
      ...
      function (
        ...
        return (
          (n.prototype.apply = function (e) {
            if (
              (null == (e = u.extend(!0, {}, this.defaults, e)).dataAdapter &&
                (null != e.ajax
                  ? (e.dataAdapter = x)
                  : null != e.data
                  ? (e.dataAdapter = b)
                ...
                0 < e.minimumInputLength &&
                  (e.dataAdapter = w.Decorate(e.dataAdapter, S)),
                0 < e.maximumInputLength &&
                  (e.dataAdapter = w.Decorate(e.dataAdapter, O)),
                0 < e.maximumSelectionLength &&
                  (e.dataAdapter = w.Decorate(e.dataAdapter, E)),
                e.tags && (e.dataAdapter = w.Decorate(e.dataAdapter, A)),
                (null == e.tokenSeparators && null == e.tokenizer) ||
                  (e.dataAdapter = w.Decorate(e.dataAdapter, C)),
                null != e.query &&
                  ((r = d(e.amdBase + 'compat/query')),
                  (e.dataAdapter = w.Decorate(e.dataAdapter, r))),
                null != e.initSelection &&
                  ((r = d(e.amdBase + 'compat/initSelection')),
                  (e.dataAdapter = w.Decorate(e.dataAdapter, r)))),
              null == e.resultsAdapter &&
                ((e.resultsAdapter = p),
                null != e.ajax &&
                  (e.resultsAdapter = w.Decorate(e.resultsAdapter, j)),
                null != e.placeholder &&
                  (e.resultsAdapter = w.Decorate(e.resultsAdapter, q)),
                e.selectOnClose &&
                  (e.resultsAdapter = w.Decorate(e.resultsAdapter, P))),
              null == e.dropdownAdapter &&
                (e.multiple
                  ? (e.dropdownAdapter = D)
                  : ((r = w.Decorate(D, T)), (e.dropdownAdapter = r)),
                0 !== e.minimumResultsForSearch &&
                  (e.dropdownAdapter = w.Decorate(e.dropdownAdapter, k)),
                e.closeOnSelect &&
                  (e.dropdownAdapter = w.Decorate(e.dropdownAdapter, I)),
                (null == e.dropdownCssClass &&
                  null == e.dropdownCss &&
                  null == e.adaptDropdownCssClass) ||
                  ((r = d(e.amdBase + 'compat/dropdownCss')),
                  (e.dropdownAdapter = w.Decorate(e.dropdownAdapter, r))),
                (e.dropdownAdapter = w.Decorate(e.dropdownAdapter, L))),
              null == e.selectionAdapter &&
                (e.multiple
                  ? (e.selectionAdapter = f)
                  : (e.selectionAdapter = h),
                null != e.placeholder &&
                  (e.selectionAdapter = w.Decorate(e.selectionAdapter, g)),
                e.allowClear &&
                  (e.selectionAdapter = w.Decorate(e.selectionAdapter, m)),
                e.multiple &&
                  (e.selectionAdapter = w.Decorate(e.selectionAdapter, y)),
                (null == e.containerCssClass &&
                  null == e.containerCss &&
                  null == e.adaptContainerCssClass) ||
                  ((r = d(e.amdBase + 'compat/containerCss')),
                  (e.selectionAdapter = w.Decorate(e.selectionAdapter, r))),
                (e.selectionAdapter = w.Decorate(e.selectionAdapter, v))),
              ...
              for (
                var t = new _(), n = (e.language.push('en'), e.language), i = 0;
                i < n.length;
                i++
              ) {
                var o = n[i],
              ...
              var r = _.loadPath(this.defaults.amdLanguageBase + 'en'),
                a = new _(e.language)
          ...
          (n.prototype.reset = function () {
            ...
            this.defaults = {
              ...
              matcher: function a (e, t) {
                if (null == e.term || '' === e.term.toString().trim()) return t
                if (t.children && 0 < t.children.length) {
                  for (
                    var n = u.extend(!0, {}, t), i = t.children.length - 1;
                    0 <= i;
                    i--
                  )
          ...
          (n.prototype.set = function (e, t) {
            var n = {},
              e = ((n[u.camelCase(e)] = t), w._convertData(n))
            u.extend(this.defaults, e)
          }),
          new n()
        )
      }
          ...
          (e.prototype.fromElement = function (e) {
            var t,
              ...
              i =
                ...
                {}),
              i =
                s.fn.jquery && '1.' == s.fn.jquery.substr(0, 2) && e[0].dataset
                  ? s.extend(!0, {}, e[0].dataset, e.data())
                  : e.data(),
              o = s.extend(!0, {}, i)
            for (t in (o = r._convertData(o)))
              -1 < s.inArray(t, n) ||
                (s.isPlainObject(this.options[t])
                  ? s.extend(this.options[t], o[t])
                  : (this.options[t] = o[t]))
            return this
          }),
      ...
      function (o, s, n, r) {
        ...
        return (
          ...
          (a.prototype._resolveWidth = function (e, t) {
            ...
            var i = e.attr('style')
            if ('string' == typeof i)
              for (var o = i.split(';'), s = 0, r = o.length; s < r; s += 1) {
      ...
      return {
        syncCssClasses: function (e, t, n) {
          var i,
            o = [],
            s =
              e.attr('class') || 0 == e.attr('class')
                ? e.attr('class').toString().trim()
                : ''
          s &&
        ...
        return (
          (t.prototype.render = function (e) {
            ...
            return (
              ...
              s.syncCssClasses(e, this.$element, i),
              e.css(o),
              e.addClass(t),
              e
            )
        ...
        return (
          (t.prototype.render = function (e) {
            var n,
              ...
              i =
                ('function' == typeof t && (t = t(this.$element)),
                this.options.get('adaptDropdownCssClass')),
              o =
                ((i = i || r),
                -1 !== t.indexOf(':all:') &&
                  ((t = t.replace(':all:', '')),
    ...
    u.define('select2/compat/initSelection', ['jquery'], function (e) {
      function t (e, t, n) {
        n.get('debug') &&
          window.console &&
          console.warn &&
        ...
        (t.prototype.current = function (e, t) {
          ...
          this._isInitialized
            ...
            : this.initSelection.call(null, this.$element, function (e) {
                ;(n._isInitialized = !0), Array.isArray(e) || (e = [e]), t(e)
              })
        }),
        t
      )
    ...
    (o = function (c) {
      ...
      if (c.event.fixHooks)
        for (var n = e.length; n; )
          c.event.fixHooks[e[--n]] = c.event.mouseHooks
      var h = (c.event.special.mousewheel = {
        ...
        setup: function () {
          ...
          c.data(this, 'mousewheel-line-height', h.getLineHeight(this)),
            c.data(this, 'mousewheel-page-height', h.getPageHeight(this))
        },
        teardown: function () {
      ...
      function i (e) {
        var t,
          ...
          l = 0
        if (
          (((e = c.event.fix(n)).type = 'mousewheel'),
          ...
          return (
            1 === n.deltaMode
              ? ((o *= t = c.data(this, 'mousewheel-line-height')),
                (r *= t),
                (s *= t))
              : 2 === n.deltaMode &&
                ((o *= t = c.data(this, 'mousewheel-page-height')),
                (r *= t),
                (s *= t)),
            (t = Math.max(Math.abs(r), Math.abs(s))),
            (!d || t < d) && g(n, (d = t)) && (d /= 40),
            g(n, t) && ((o /= 40), (s /= 40), (r /= 40)),
            (o = Math[1 <= o ? 'floor' : 'ceil'](o / d)),
            (s = Math[1 <= s ? 'floor' : 'ceil'](s / d)),
            (r = Math[1 <= r ? 'floor' : 'ceil'](r / d)),
            h.settings.normalizeOffset &&
            ...
            u && clearTimeout(u),
            (u = setTimeout(f, 200)),
            (c.event.dispatch || c.event.handle).apply(this, i)
          )
      }
      function f () {
        d = null
    ...
    'function' == typeof u.define && u.define.amd
      ? u.define('jquery-mousewheel', ['jquery'], o)
  ...
  var e,
    ...
    w,
    o,
    a = { define: u.define, require: u.require }
  function _ (e, t) {
    return n.call(e, t)
  }
  function l (e, t) {
