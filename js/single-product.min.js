jQuery(function (s) {
  ...
  s('body')
    ...
    .on('click', '.wc-tabs li a, ul.tabs li a', function (t) {
      ...
      e.find('.wc-tabs, ul.tabs').find('li').removeClass('active'),
        e.find('.wc-tab, .panel:not(.panel .panel)').hide(),
  ...
  ;(e.prototype.initFlexslider = function (t) {
        ...
        0 < t.length &&
          t.each(function (t, e) {
            ...
            e.length &&
              ...
              (i = e.attr('data-large_image_width')),
              (o = e.attr('data-large_image_height')),
              (a = {
                alt: e.attr('alt'),
                src: a,
                w: i,
    ...
    (e.prototype.openPhotoswipe = function (t) {
      ...
      var e = s('.pswp')[0],
        ...
        t = s(t.target),
        t =
          0 < t.closest('.woocommerce-product-gallery__trigger').length
