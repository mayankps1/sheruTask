            ...
            for (r = 0; r < h; r++)
              if ('string' == typeof t[r]) g += t[r]
                ...
                switch ((i.number.test(s.type) && (p = e >= 0), s.type)) {
                  ...
                  case 'e':
                    e = s.precision
                      ? parseFloat(e).toExponential(s.precision)
                      : parseFloat(e).toExponential()
                    break
                  case 'f':
                    e = s.precision
                      ? parseFloat(e).toFixed(s.precision)
                      : parseFloat(e)
                    break
                  case 'g':
                    e = s.precision
                      ? String(Number(e.toPrecision(s.precision)))
                      : parseFloat(e)
                    break
                  case 'o':
          ...
          function l (t) {
            ...
            for (var n, e = t, r = [], o = 0; e; ) {
              if (null !== (n = i.text.exec(e))) r.push(n[0])
                ...
                if (null === (n = i.placeholder.exec(e)))
    ...
    function d (t) {
      var n = (function (t) {
        for (var n, e, r, i, o = [], a = []; (n = t.match(p)); ) {
          for (
            e = n[0], (r = t.substr(0, n.index).trim()) && o.push(r);
            (i = a.pop());
    ...
    ;(g.prototype.getPluralForm = function (t, n) {
      ...
      return (
        o ||
          ('function' !=
            typeof (i =
              (e = this.data[t][''])['Plural-Forms'] ||
              e['plural-forms'] ||
              e.plural_forms) &&
            ((r = (function (t) {
              var n, e, r
              for (n = t.split(';'), e = 0; e < n.length; e++)
                if (0 === (r = n[e].trim()).indexOf('plural='))
                  return r.substr(7)
      ...
      y = (t, n, e) => {
        ...
        return {
          ...
          __: (t, n) => {
            let r = u(n, void 0, t)
            return e
              ? ((r = e.applyFilters('i18n.gettext', r, t, n)),
                e.applyFilters('i18n.gettext_' + l(n), r, t, n))
              : r
          },
          _x: c,
          _n: (t, n, r, i) => {
