        ...
        init: function () {
          ;(m.animating = !1),
            ...
            m.vars.slideshow &&
              ...
              (m.vars.pauseInvisible && c.pauseInvisible.isHidden()) ||
                (0 < m.vars.initDelay
            ...
            (x && !m.vars.smoothHeight) ||
              u(window).on('resize orientationchange focus', c.resize),
                ...
                : m.slides.on(s, function (e) {
                    ...
                    var e = u(this),
                      ...
                      a = m.vars.rtl
                        ...
                        : e.offset().left - u(m).scrollLeft()
                    a <= 0 && e.hasClass(r + 'active-slide')
      ...
      if ('object' == typeof (a = a === undefined ? {} : a))
        return this.each(function () {
          ...
          ;(1 === t.length && !1 === a.allowOneSlide) || 0 === t.length
            ...
            : e.data('flexslider') === undefined && new u.flexslider(this, a)
        })
