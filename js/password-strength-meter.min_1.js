  ...
  (function (a) {
    ...
    ;(wp.passwordStrength = {
      ...
      userInputDisallowedList: function () {
        ...
        for (
          s.push(document.title), s.push(document.URL), n = o.length, e = 0;
          e < n;
          e++
        )
          0 !== (r = a('#' + o[e])).length &&
            (s.push(r[0].defaultValue), s.push(r.val()))
        for (t = s.length, e = 0; e < t; e++)
          s[e] && (i = i.concat(s[e].replace(/\W/g, ' ').split(' ')))
